...
public class _406_根据身高重建队列 {
    public int[][] reconstructQueue(int[][] people) {
        //return this.considerFromLowToHigh(people);

        return this.considerFromHighToLow(people);
    }

    int[][] considerFromLowToHigh(int[][] people) {
        Arrays.sort(
                people,
    ...
    int[][] considerFromHighToLow(int[][] people) {
        Arrays.sort(
                people,
