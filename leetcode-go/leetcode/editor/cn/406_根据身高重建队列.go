...
func reconstructQueue(people [][]int) [][]int {
	//return considerFromLowToHigh(people)

	return considerFromHighToLow(people)
}

func considerFromLowToHigh(people [][]int) [][]int {
...
func considerFromHighToLow(people [][]int) [][]int {
	sort.Slice(people, func(i, j int) bool {
		a, b := people[i], people[j]
		return a[0] > b[0] || a[0] == b[0] && a[1] < b[1]
	})
