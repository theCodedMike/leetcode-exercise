<p>你正在探访一家农场，农场从左到右种植了一排果树。这些树用一个整数数组 <code>fruits</code> 表示，其中 <code>fruits[width]</code> 是第 <code>width</code> 棵树上的水果 <strong>种类</strong> 。</p>
...
<ul> 
 ...
 <li><code>0 &lt;= fruits[width] &lt; fruits.length</code></li> 
</ul>
