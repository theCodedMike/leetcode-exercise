<p>Given an array of strings <code>words</code> and a width <code>max_width</code>, format the text such that each line has exactly <code>max_width</code> characters and is fully (left and right) justified.</p>
